...
import com.hospital.clinica.service.impl.UsuarioSecurityServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	//Esto toma los valores del applicaion.properties en la parde de datasources (base de datos)
	//@Autowired
	//private javax.sql.DataSource dataSource;
	
	
	//Esto es para ligar la tabla de usuarios con el login, especificar que los usuarios los o login los tome o haga con 
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		.and()
		.csrf() //deshabilita el token por defecto que brind spring para darle paso a JWT
		.disable();
	}
	...
	public TokenStore tokenStore() {
		...
		//return new JdbcTokenStore(this.dataSource); // Esto es para guardar el token en base de datos
	}
	...
	//ESTO SOLO ES PARA EJEMPLOS DE UTILIZAR USUARIOS EN MEMORIA, COMO SI LOS DECLARARAMOS DIRECTO EN EL PROPERTIES
	/*@Override
	protected void configure (AuthenticationManagerBuilder auth) throws Exception {
